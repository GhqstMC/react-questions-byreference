        ...
        <div className="bg-lgray-900 w-full h-screen font-outfit flex">
            <div
                ...
                <ul role="list" className="divide-y divide-lgray-750">
                    <div onClick={() => setAnswerVisible(prev => !prev)}>
                        <AnimatePresence initial={false} mode="popLayout">
                            {answerVisible &&

                                <motion.div
                                    key="answer"
                                    initial={{x: 30, opacity: 0, height: 'auto'}}
                                    transition={{
                                        delay: 0.3,
                                        height: {
                                            delay: 0
                                ...
                                >
                                    <li className="px-4 py-4 pb-2 sm:px-6 text-center text-xl">
                                        {question.answer}
                                    </li>
                                </motion.div>
                            }
                            {!answerVisible &&
                                ...
                                <motion.div
                                    ...
                                    animate={{x: 0, opacity: 1}}
                                    exit={{
                                        x: -30, opacity: 0, height: 0, transition: {
                                            height: {
                                                delay: 0.3
                                            }
                                        }
                                ...
                                >
                                    ...
                                    <li className="px-4 pt-2 pb-4 sm:px-6 text-center text-xl">
                    ...
                    <li className="px-4 py-1 sm:px-6 text-center text-sm font-light">
                    ...
                    <li className="px-4 py-4 sm:px-6 text-center text-xl">
                        ...
                        <motion.button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 h-5 w-5" fill="none"
                                 viewBox="0 0 24 24"
                                 stroke="currentColor">
                        ...
                        <motion.button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="mr-1 h-5 w-5" fill="currentColor"
                                 viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path
